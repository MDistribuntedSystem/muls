...
const (
	Append      ProtocolAction = 1
	BatchAppend ProtocolAction = 2
	Read        ProtocolAction = 3
	Clean       ProtocolAction = 4
	Delete      ProtocolAction = 5
)

type ProtocolLevel uint32

const (
	Normal    ProtocolLevel = 1
	Warning   ProtocolLevel = 2
	Error     ProtocolLevel = 3
	Debug     ProtocolLevel = 4
	Important ProtocolLevel = 5
)
...
func NewProtocol(action ProtocolAction, pool string, level ProtocolLevel, time uint32) *Protocol {
